...
class ElectionMetaData
{
    public ElectionMetaData()
    {
        ...
        _parties = new Lazy<Dictionary<string, PartyData>>(LoadParties);
        _districts = new Lazy<Dictionary<string, string>>(LoadDistricts);
    ...
    private Lazy<Dictionary<string, PartyData>> _parties;
    public Dictionary<string, PartyData> Parties => _parties.Value;

    private Lazy<Dictionary<string, string>> _districts;
    public Dictionary<string, string> Districts => _districts.Value;
    ...
    private Dictionary<string, PartyData> LoadParties()
    {
        return File
    ...
    private Dictionary<string, string> LoadDistricts()
    {
